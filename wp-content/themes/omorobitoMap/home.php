...
<head>
    ...
    <!-- ワードプレスのスタイルを読み込む -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/reset.css" type="text/css" />
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/style.css" type="text/css" />
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/common.css" type="text/css" />
...
<body class="drawer drawer--right">
    ...
    <main role="main">
        ...
        <nav id="navbar">
            <ul class="menu">
                <li>
                    <a href="http://saicololo.com/"><img alt="omorobitomap_logo" height="65" src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo.gif" width="230"></a>
                </li>
                <li>
        ...
        <section>
            <div>
                <img alt="メインイメージ" id="top_content" src="<?php echo get_stylesheet_directory_uri(); ?>/images/maintop.jpg"> </div>
        ...
        <section>
            <div>
                ...
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/line.png" id="line" width="400px">
            </div>
            <p class="bigmap"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/map1.jpg" alt="大きい地図" usemap="#Map">
                <map name="Map">
                ...
                <ul class="media-container clearfix">
                    <li class="media-list media-hover-04">
                        <a href="#" class="media-link">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/article10.jpg" width="300px" height="auto" alt="">
                            <div class="lower-box">
                    ...
                    <li class="media-list media-hover-04">
                        <a href="#" class="media-link">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/article1.jpg" width="300px" height="auto" alt="">
                            <div class="lower-box">
                                <span class="tag tag-media">メディア</span>
                                <date class="date">2015 5-15</date>
                                <p class="title">タイトルが入ります。タイトルが入ります。タイトルが入ります。</p>
                    ...
                    <li class="media-list media-hover-04">
                        <a href="#" class="media-link">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/article2.jpg" width="300px" height="auto" alt="">
                            <div class="lower-box">
                                <span class="tag tag-media">メディア</span>
                                <date class="date">2015 5-15</date>
                                <p class="title">タイトルが入ります。タイトルが入ります。タイトルが入ります。</p>
                    ...
                    <li class="media-list media-hover-04">
                        <a href="#" class="media-link">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/article3.jpg" width="300px" height="auto" alt="">
                            <div class="lower-box">
                                <span class="tag tag-media">メディア</span>
                                <date class="date">2015 5-15</date>
                                <p class="title">タイトルが入ります。タイトルが入ります。タイトルが入ります。</p>
                    ...
                    <li class="media-list media-hover-04">
                        <a href="#" class="media-link">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/article5.jpg" width="300px" height="auto" alt="">
                            <div class="lower-box">
                                <span class="tag tag-media">メディア</span>
                                <date class="date">2015 5-15</date>
                                <p class="title">タイトルが入ります。タイトルが入ります。タイトルが入ります。</p>
                    ...
                    <li class="media-list media-hover-04">
                        <a href="#" class="media-link">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/article8.jpg" width="300px" height="auto" alt="">
                            <div class="lower-box">
                                <span class="tag tag-media">メディア</span>
                                <date class="date">2015 5-15</date>
                                <p class="title">タイトルが入ります。タイトルが入ります。タイトルが入ります。</p>
        ...
        <!--先頭に戻るボタン-->
        <p class="pagetop"><a href="#container"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pagetop.png" width="60px" alt="PAGE TOP" /></a></p>
