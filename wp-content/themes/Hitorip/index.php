...
<body class="drawer drawer--right">
    ...
    <nav id="navbar">
        <ul class="menu">
            <li>
                <a href="index.html"><img alt="omorobitomap_logo" height="65" src="images/logo.gif" width="230"></a>
            </li>
            <li>
                <a class="navbarmain" href="../page/page.html"><span class="navbarmain-main">About</span><span class="navbarmain-sub">サイトについて</span></a>
            </li>
            <li>
                <a class="navbarmain" href="../category-AllPeople/category-AllPeople.html"><span class="navbarmain-main">people</span><span class="navbarmain-sub">人を見る</span></a>
            </li>
            <li>
    ...
    <main role="main">
        ...
        <div id="main">
            <div id="mainPhoto">
                <ul class="bxslider">
                    <li><img src="../common/images/top1.jpg" /></li>
                    <li><img src="../common/images/top2.jpg" /></li>
                    <li><img src="../common/images/top3.jpg" /></li>
                </ul>
            </div>
            <!-- mainPhoto end-->
            ...
            <div id="container">
                ...
                <div id="content" class="clearfix">
                    ...
                    <article class="item">
                        <a class="item-image" href="../single-colombia/single-colombia.html">
            ...
            <section>
                ...
                <p class="bigmap"> <img src="images/map1.jpg" alt="大きい地図" usemap="#Map">
                    <map name="Map">
                <area shape="circle" coords="300,416,76" href="../category-southAmerica/category-southAmerica.html">
                ...
                <div class="inner">
                    <ul class="media-container clearfix">
                        <li class="media-list media-hover-04">
                            <a href="/single-ArticleEnglish/single-ArticleEnglish.html" class="media-link">
                        ...
                        <li class="media-list media-hover-04">
                            <a href="#" class="media-link">
                            <img src="images/article6.jpg" width="300px" height="auto" alt="">
                            <div class="lower-box">
                                <span class="tag tag-media">メディア</span>
                                <date class="date">2015 5-15</date>
                                <p class="title">タイトルが入ります。タイトルが入ります。タイトルが入ります。</p>
